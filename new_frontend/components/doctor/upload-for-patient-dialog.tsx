...
interface UploadForPatientDialogProps {
  patientId: string
  patientName: string
  onUploadSuccess: () => void
}

export function UploadForPatientDialog({ patientId, patientName, onUploadSuccess }: UploadForPatientDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: `Medical record uploaded for ${patientName}`,
      })
      ...
      <DialogContent>
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>Upload a medical record for {patientName}</DialogDescription>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            ...
            <div className="grid gap-2">
              ...
              <Select value={recordType} onValueChange={setRecordType} required>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="Diagnosis Report">Diagnosis Report</SelectItem>
            ...
            <div className="grid gap-2">
              ...
              <Textarea
                id="description"
                placeholder="Add clinical notes or description..."
                value={description}
